...
import PesCoverReport from './PesCoverReportA';
...
// formData.append('expected_type', expectedType);
    ...
    const response = await axios.post(
      `${BACKEND_API}/upload-pes-cover-A-classification?expected_type=${selectedSide}`, // Use selected side from state
...
const resetCropper = () => {
  ...
  const deleteReport= async()=>{
    const response = await axios.delete(`${BACKEND_API}/delete-pes-cover-A-classification/${addedItem.file_id}`, 
  ...
  return (
    ...
    <PesCoverReport addedItem={addedItem} totalCrateCount={totalCrateCount} />
    {/* ---------show crop modal---------------- */}
    <Dialog
        open={showCropModal}
