...
const PesCoverReport = ({ addedItem, totalCrateCount }) => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await axios.get(`${BACKEND_API}/pes-cover-A-images-data-classification`, {
          headers: {
