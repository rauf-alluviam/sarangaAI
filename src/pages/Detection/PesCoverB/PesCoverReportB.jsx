...
// import PesCover from './PesCoverA';

const BACKEND_API = import.meta.env.VITE_BACKEND_API;

const PesCoverReportB = ({ addedItem, totalCrateCount }) => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await axios.get(`${BACKEND_API}/pes-cover-B-images-data-classification`, {
          headers: {
...
export default PesCoverReportB;
