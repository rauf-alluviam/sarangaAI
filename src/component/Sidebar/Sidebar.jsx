...
{/* -------------------------------------- */}
                  ...
                  <Button onClick={()=> {navigate('/fire'), setIsSliderOpen(false)}}  className="sidebar-link">
                    <ListItemButton
                      sx={{ textAlign: "left" }}
                      className="appbar-links"
                      style={{ padding: "5px 0" }}
                    >
                      ...
                      >
                        ...
                        {!isMinimize && <p className="sidebar-list-text">Report</p>}
                  ...
                  <Button onClick={()=> {navigate('/fg-stock'), setIsSliderOpen(false)}}  className="sidebar-link"  style={{borderLeft: (path == '/fg-stock') && '5px solid rgb(241, 92, 109)', borderRadius: '8px'}}>
                    ...
                    >
                      ...
                      >
                        ...
                        {!isMinimize && <p className="sidebar-list-text">Boards</p>}
