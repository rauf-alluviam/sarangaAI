...
import "./Sidebar.scss";
import { Button, IconButton, List, ListItem, ListItemButton, useMediaQuery, Collapse } from "@mui/material";
      ...
      <List>
        ...
        {sidebarSections.map((section) => (
          <div key={section.id}>
            ...
            <ListItem disableGutters={true} className="sidebar-listItem">
              <Button
                onClick={() => !isMinimize && toggleSection(section.id)}
                className="sidebar-link section-header"
                style={{ cursor: isMinimize ? 'default' : 'pointer' }}
              >
                <ListItemButton
                  sx={{ textAlign: "left" }}
                  className="appbar-links"
                    ...
                    >
                      ...
                      >
                        <div style={{ display: "flex", alignItems: "center", padding: "0 10px" }}>
                          ...
                          <p className="sidebar-list-text">{item.title}</p>
                        </div>
                      </ListItemButton>
                    </Button>
                  </ListItem>
